...
minetest.register_craftitem("protector:tester", {
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		local owner = ctf.get_territory_owner(pointed_thing.under)
		if owner then
			minetest.chat_send_player(user:get_player_name(), "This area is owned by ".. owner)
		else
