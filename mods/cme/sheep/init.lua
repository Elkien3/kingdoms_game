...
local def = {
	...
	modes = {
		...
		-- special modes
		follow = {chance = 0, duration = 10, radius = 8, timer = 1, moving_speed = 1, items = {"farming:wheat"}},
		eat = {	chance = 0.25,
			duration = 4,
			nodes = {
				"default:grass_1", "default:grass_2", "default:grass_3",
				"default:grass_4", "default:grass_5", "default:dirt_with_grass", "default:water_source", "default:water_flowing", "default:river_water_source", "default:river_water_flowing"
			}
		},
	},
